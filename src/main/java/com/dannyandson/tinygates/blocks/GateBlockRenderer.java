...
public class GateBlockRenderer implements BlockEntityRenderer<AbstractGateBlockEntity> {
    ...
    public void render(AbstractGateBlockEntity gateBlockEntity, float p_112308_, PoseStack poseStack, MultiBufferSource buffer, int combinedLight, int p_112312_) {
        ...
        //todo rotate based on gate facing
        ...
        RenderHelper.drawRectangle(builder, poseStack, 0, 1, 0, 1, sprite_top, combinedLight, color, 1.0f);

        poseStack.mulPose(Vector3f.XP.rotationDegrees(90));
        poseStack.translate(0, -0.125, 0);
        RenderHelper.drawRectangle(builder, poseStack, 0, 1, 0, .125f, sprite, combinedLight, color, 1.0f);
        ...
        poseStack.mulPose(Vector3f.XP.rotationDegrees(90));
        poseStack.translate(0, -1, 0);
        RenderHelper.drawRectangle(builder, poseStack, 0, 1, 0, 1, sprite, combinedLight, color, 1.0f);
