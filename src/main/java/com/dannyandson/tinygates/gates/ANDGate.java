...
public class ANDGate extends AbstractGate {
    ...
    public void render(MatrixStack matrixStack, IRenderTypeBuffer buffer, int combinedLight, int combinedOverlay, float alpha) {
        ...
        TextureAtlasSprite sprite_and_gate = output?RenderHelper.getSprite(TEXTURE_AND_GATE_ON):RenderHelper.getSprite(TEXTURE_AND_GATE_OFF);

        com.dannyandson.tinygates.RenderHelper.drawQuarterSlab(matrixStack,builder,sprite_and_gate,sprite,combinedLight,alpha);
    }
